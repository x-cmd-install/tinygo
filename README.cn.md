...
合计: **152,416** 行代码（覆盖前 5 种语言、共 **1914** 个文件）。
...
- **Star**: 17,750 · **Fork**: 1,079 · **开放 issue**: 1,857 · **贡献者**: 247

## 累计统计

- **发布数**: 52 · **已合并 PR**: 3006 · **开放 PR**: 111 · **已关闭 issue**: 1432 · **开放 issue**: 425 · **提交数**: 4899
...
_数据快照: `data/card/260921.yml` · 2026-09-21T06:26:32Z._
